...
const MoveCaroSchema = new Schema({
  userId: { type: Schema.Types.ObjectId, ref: 'User' }, // ID người chơi thực hiện nước đi
...
const GameCaroSchema = new Schema({
  ...
  playerX: { type: Schema.Types.ObjectId, ref: 'User' }, // ID người chơi quân X
  playerO: { type: Schema.Types.ObjectId, ref: 'User' }, // ID người chơi quân O
  winnerId: { type: Schema.Types.ObjectId, ref: 'User', default: null }, // ID người thắng (null nếu hòa)
